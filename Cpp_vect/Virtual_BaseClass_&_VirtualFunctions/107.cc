// Here virtual key word is attached to the base class function. So function binding will happen at runtime and not compile time.
// Virtual Functions are helpful to get Runtime Function Bindings. Without Virtual, Compile Time Binding.
...
int main(){
	...
	at runtime bptr will be assigned with d1's address so further on execution. Class D's get_Data function will be executed.
	*/
