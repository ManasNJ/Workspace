...
// Usage of this file , for compiling : cc DRL_p1.c dynamic_libabc.so
/* Though even after using above command we will get ubdefined regerence for dlfcn.h. Because dlfcn.h is a Linux based standard Library.*/
#include <stdio.h>
#include <dlfcn.h>
